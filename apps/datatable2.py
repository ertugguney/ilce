...
df = pd.read_csv('http://crm.trakyaka.org.tr/ap/datasets/ilceData_04.12.21_Il_Ilcesiz.csv',sep=',',encoding='utf-8-sig')

# https://media.githubusercontent.com/media/ertugguney/datasets/main/ilceData_04.12.21_Il_Ilcesiz.csv

yerlesim= pd.read_csv('http://crm.trakyaka.org.tr/ap/datasets/yerlesim.csv',sep=',',encoding='windows-1254')
...
def func(n_clicks):
    if n_clicks is None:
        ...
        # return dcc.send_data_frame(df1.to_csv, "ilce_istatistikleri.csv")
        return dcc.send_file( "http://crm.trakyaka.org.tr/ap/datasets/yerlesim.csv")
...
def func(n_clicks):
    if n_clicks is None:
        ...
        # return dcc.send_data_frame(df1.to_csv, "ilce_istatistikleri.csv")
        return dcc.send_file( "http://crm.trakyaka.org.tr/ap/datasets/metaveri.csv")
